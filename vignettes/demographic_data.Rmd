...
# Data literacy filter to have a population's count under specific conditions
lit <- literacy %>%
...
head(lit)
# Data marital status filter to have a population's count under specific conditions
ms <- marital_status %>%
...
new_row <- data.frame(
  ...
  sexo = "total", total = ms_count$total
)
