...
**As an important clarification, all data is loaded and not downloaded, which means it will be stored as part of the environment, but will not be downloaded to user's computer.**
:::
