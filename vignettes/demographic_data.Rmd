...
**ColOpenData** can be used to access open demographic data from Colombia. This demographic data is retrieved from the National Administrative Department of Statistics ([DANE](https://www.dane.gov.co/index.php/estadisticas-por-tema)). The demographic module allows you to consult demographic data from the National Population and Dwelling Census (CNPV) of 2018.
