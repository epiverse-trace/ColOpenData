---
title: "Analyzing Colombian CNPV Data with ColOpenData: A Comprehensive Overview"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Analyzing Colombian CNPV Data with ColOpenData: A Comprehensive Overview}
...
ggplot(merged_df, aes(x = estado, y = proportion, fill = sexo)) +
  ...
  scale_fill_manual(values = c("mujer" = "#f04a4c", "hombre" = "#aec800")) +
  labs(
