...
To better understand dataset names and details please refer to [Documentation and Dictionaries](https://epiverse-trace.github.io/ColOpenData/articles/documentation_and_dictionaries.html).
...
::: {style="text-align: justify;"}
After exploring the dictionary, we can identify the column that contains the individual municipality codes is [DPTO_CCDGO]{.underline}. We will filter based on that column.
:::
