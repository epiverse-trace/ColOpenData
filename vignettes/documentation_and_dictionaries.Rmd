...
climate. All the available datasets have different details and aggregation and a naming system that is used to retrieve the data. All datasets need to have a source, given name, year and additional details for identification. They can be consulted using a common framework:
