...
Geospatial datasets naming is related to the level of aggregation, since they are available from Blocks to Departments. All these datasets come from DANE, and are part of the Geostatistical National Framework (MGN), which for 2018 includes a summarized version of the National Populationa and Dwelling Census (CNPV). Naming is stated as follows:
...
National Population and Dwelling Census (CNPV) and a dictionary is needed to
