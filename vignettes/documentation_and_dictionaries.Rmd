...
category; however, the available datasets can be consulted using a common name framework:
...
This function can also receive a string parameter to indicate a specific group.
