...
::: {style="text-align: justify;"}
This naming framework is only used for the functions `download_demographic`. For hands on examples please check [A Deep Dive into Colombian Demographics Using ColOpenData](https://epiverse-trace.github.io/ColOpenData/articles/demographic_data.html).
:::
