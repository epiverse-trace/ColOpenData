...
Demographic datasets are available for municipalities and departments, and contain data for Dwellings, Households and Population in four categories.
...
To check available datasets you can use the `list_datasets` function. This function can also be filtered with the `module` parameter to indicate a specific module
:::
```{r setup}
library(ColOpenData)
```
