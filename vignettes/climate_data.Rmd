...
- `end_date`: character with the last date to consult in the format `"YYYY-MM_DD"`. 
(Last available date is `"2023-05-31"`
- `frequency`: character with the aggregation frequency. (`"day"`, `"week"`, 
`"month"` or `"year"`)
- `tags`: character containing climate tags to consult
- `aggregate`: logical for data aggregation, if `FALSE`, returns the data from 
each individual station in the area. (Default = `TRUE`)
