...
For this example we will retrieve data for the city of Manizales in Colombia. We will download Maximum Temperature (TMX_CON) from 2013 to 2016, to observe the increase in temperature during 2015 and 2016 due to the impact of El Nino (ENSO).
...
::: {style="text-align: justify;"}
The three methods display the same results by different methods.
:::
