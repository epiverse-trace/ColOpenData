...
**ColOpenData** contains data from two public data sources: The National Administrative Department of Statistics [(DANE)](https://www.dane.gov.co/), and the Institute of Hydrology, Meteorology and Environmental Studies [(IDEAM)](https://ideam.gov.co). The available data is divided in four categories:
