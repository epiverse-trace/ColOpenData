...
visualize Dengue cases in a specific region. We will first load the needed packages.
...
using `filter_mgn_cnpv`. For this example will be selecting the departments in 
